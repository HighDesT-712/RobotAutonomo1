...
setup()
{
...

  {
    ...
    Config cfg;
    cfg.setPins(pins::AiThinker); //en realidad es esp-eye porque modifique la libreria de esp32cam para que se inicialize con los pines del esp-eye, me guie del codigo generado por edge impulse ahi estanlospines utilizados
